      ...
      <div className="flex justify-between items-center gap-5 ">
        <div className="hidden md:flex justify-between items-center gap-5">
          ...
          <div className="relative">
            ...
            <span className="absolute -top-2 -right-2 items-center justify-center px-[0.4rem] py-1 text-xs font-semibold leading-none text-red-100 bg-red-400 rounded-full">
              3
            </span>
          </div>
          ...
          <div className="flex items-center gap-3 cursor-pointer">
            ...
            <span className="font-semibold">Efe Caglar</span>
          </div>
        </div>
        <Link href="/settings">
