export const features = [
  {
    ...
    text: "“To provide seamless, reliable, and efficient third-party logistics solutions that ensure products are ready for success at new locations, empowering businesses to grow and thrive.”",
    button: {
  ...
  },
  {
    ...
    text: "To be the trusted partner in logistics, known for our commitment to excellence, innovation, and customer satisfaction, enabling businesses to expand effortlessly across new markets.",
    button: {
...
export const faq = [
  {
    id: "0",
    question: "What is Amazon fulfillment, and how does it work?",
    answer:
      "Amazon fulfillment involves managing storage, packing, and shipping of products on behalf of sellers to ensure efficient delivery to customers. We handle all these aspects to streamline your operations.",
  },
  {
    id: "1",
    question: "How do I send my inventory to your fulfillment center?",
    answer:
      "You simply create a shipment plan in your Amazon Seller Central account and send your inventory directly to our designated fulfillment center. We’ll handle the rest.",
  },
  {
    id: "2",
    question: "What types of products can you fulfill for Amazon sellers?",
    answer:
      "We can fulfill a wide range of products, including standard-sized items, oversized goods, and non-hazardous materials. Contact us for any special requirements.",
  },
  {
    id: "3",
    question:
      "Do you provide assistance with FBA product labeling and packaging?",
    answer:
      "Yes, we offer FBA-compliant labeling and packaging services to ensure your products meet Amazon's requirements.",
  },
  {
    id: "4",
    question: "How do you handle returns and refunds for Amazon orders?",
    answer:
      "We process returns and refunds in line with Amazon's guidelines, inspecting returned items and ensuring proper crediting to your account.",
  },
  {
    id: "5",
    question:
      "What is the cost structure for your Amazon fulfillment services?",
    answer:
      "Our pricing depends on factors like storage space, product size, order volume, and any additional services required. Contact us for a customized quote.",
  },
  {
    id: "6",
    question: "Can I track my inventory and shipments in real time?",
    answer:
      "Absolutely! We provide an integrated tracking system so you can monitor your inventory levels and order status at all times.",
  },
  {
    id: "7",
    question: "Do you assist with Amazon compliance and account management?",
    answer:
      "Yes, we help with compliance matters such as product prep and FBA requirements, and we can guide you on account management best practices.",
  },
  {
    id: "8",
    question: "How do I get started with your Amazon fulfillment services?",
    answer:
      "Simply reach out to us via our contact page or email, and we’ll guide you through the onboarding process step by step.",
  },
];
...
export const plans = [
  ...
  },
  {
    ...
    priceMonthly: 149,
    priceYearly: 120,
    caption: "Ideal for large-scale operations",
    features: [
...
export const testimonials = [
  {
    ...
    comment:
      "This fulfillment service has been a game-changer for my business. Fast, reliable, and stress-free!",
  },
  {
    id: "1",
    name: "David Martinez",
    ...
    comment:
      "Managing inventory and shipments used to be overwhelming, but now everything runs like clockwork.",
  },
  {
    id: "2",
    name: "Emily Roberts",
    ...
    comment:
      "Their customer support team is phenomenal! They guided me through the setup process with ease.",
  },
  {
    id: "3",
    name: "Michael Lee",
    ...
    comment:
      "Since switching to this service, I've seen significant savings in time and costs. Highly recommend!",
  },
  {
    id: "4",
    name: "Jessica Brown",
    ...
    comment:
      "The level of attention to detail and care they provide is unmatched. I trust them completely with my operations.",
  },
  {
    id: "5",
    name: "Daniel Carter",
    ...
    comment:
      "This service helped me scale my business faster than I thought possible. Worth every penny!",
  },
];
