...
const Header = () => {
 ...
 const NavLink = ({ title, href }: NavLinkProps) => (
   <a
     ...
     className="base-bold text-s2 uppercase transition-colors duration-500 cursor-pointer hover:text-p1 max-lg:my-4 max-lg:h5"
   >
     {title}
   </a>
 );
  ...
  return (
    <header
      className={clsx(
        ...
        hasScrolled && "py-2 bg-gray-50 backdrop-blur-[8px]"
      )}
    >
      <div className="container flex h-14 items-center max-lg:px-5">
        <a className="lg:hidden flex-1 cursor-pointer z-2">
          <img src="/images/fbm-b.png" width={115} height={55} alt="logo" />
        </a>
